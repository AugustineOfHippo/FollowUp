...
export default function SearchBarContainer() {
        ...
        const filterFunction = (e) => {
                switch(e.target.textContent){
                        case 'ALL':
                                ...
                                fetch('http://35.168.3.189:5555/stats/all')
                                .then(res => res.json())
                                .then(data => {
                                ...
                                break;
                        case 'TODAY':
                                fetch('http://35.168.3.189:5555/customer/today')
                                .then(res => res.json())
                                .then(data => {
                                        dispatch(setCustomer(data))
                                })
                                fetch('http://35.168.3.189:5555/stats/today')
                                .then(res => res.json())
                                .then(data => {
                                  dispatch(setClosedSale(data.closed))
                                  dispatch(setPendingSale(data.pending))
                        ...
                        case 'WEEK':
                                fetch('http://35.168.3.189:5555/customer/thisweek')
                                .then(res => res.json())
                                .then(data => {
                                        dispatch(setCustomer(data))
                                })
                                fetch('http://35.168.3.189:5555/stats/thisweek')
                                .then(res => res.json())
                                .then(data => {
                                  dispatch(setClosedSale(data.closed))
                                  dispatch(setPendingSale(data.pending))
                        ...
                        case 'MONTH':
                                fetch('http://35.168.3.189:5555/customer/thismonth')
                                .then(res => res.json())
                                .then(data => {
                                        dispatch(setCustomer(data))
                                })
                                fetch('http://35.168.3.189:5555/stats/thismonth')
                                .then(res => res.json())
                                .then(data => {
                                  dispatch(setClosedSale(data.closed))
                                  dispatch(setPendingSale(data.pending))
                        ...
                        case 'YEAR':
                                fetch('http://35.168.3.189:5555/customer/thisyear')
                                .then(res => res.json())
                                .then(data => {
                                        dispatch(setCustomer(data))
                                })
        ...
        const searchFunction = (e) => {
                ...
                fetch('http://35.168.3.189:5555/customer/search', {
                method:'POST',
                headers: {
