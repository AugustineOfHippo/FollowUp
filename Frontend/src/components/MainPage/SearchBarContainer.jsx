...
export default function SearchBarContainer() {
        ...
        const filterFunction = (e) => {
                switch(e.target.textContent){
                        case 'ALL':
                                ...
                                fetch('http://localhost:3001/stats/all')
                                .then(res => res.json())
                                .then(data => {
                                ...
                                break;
                        case 'TODAY':
                                fetch('http://localhost:3001/customer/today')
                                .then(res => res.json())
                                .then(data => {
                                        dispatch(setCustomer(data))
                                })
                                fetch('http://localhost:3001/stats/today')
                                .then(res => res.json())
                                .then(data => {
                                  dispatch(setClosedSale(data.closed))
                                  dispatch(setPendingSale(data.pending))
                        ...
                        case 'WEEK':
                                fetch('http://localhost:3001/customer/thisweek')
                                .then(res => res.json())
                                .then(data => {
                                        dispatch(setCustomer(data))
                                })
                                fetch('http://localhost:3001/stats/thisweek')
                                .then(res => res.json())
                                .then(data => {
                                  dispatch(setClosedSale(data.closed))
                                  dispatch(setPendingSale(data.pending))
                        ...
                        case 'MONTH':
                                fetch('http://localhost:3001/customer/thismonth')
                                .then(res => res.json())
                                .then(data => {
                                        dispatch(setCustomer(data))
                                })
                                fetch('http://localhost:3001/stats/thismonth')
                                .then(res => res.json())
                                .then(data => {
                                  dispatch(setClosedSale(data.closed))
                                  dispatch(setPendingSale(data.pending))
                        ...
                        case 'YEAR':
                                fetch('http://localhost:3001/customer/thisyear')
                                .then(res => res.json())
                                .then(data => {
                                        dispatch(setCustomer(data))
                                })
                                fetch('http://localhost:3001/stats/thisyear')
                                .then(res => res.json())
                                .then(data => {
                                  dispatch(setClosedSale(data.closed))
                                  dispatch(setPendingSale(data.pending))
        ...
        const searchFunction = (e) => {
                ...
                fetch('http://localhost:3001/customer/search', {
                method:'POST',
                headers: {
